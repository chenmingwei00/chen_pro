...
FLAGS=None
#获取数据对应的path路径
target_dir=FLAGS.data_dir# /
mode=FLAGS.mode
train_file = os.path.join(target_dir,"ai_challenger_oqmrc_trainingset.json")#/home/admin/data/squad/train-v1.1.json
dev_file = os.path.join(target_dir, "ai_challenger_oqmrc_validationset.json")
test_file = os.path.join(target_dir, "ai_challenger_oqmrc_testa.json")
glove_word_file = os.path.join(target_dir,"cc.zh.300.vec")
glove_word_file1 = os.path.join(target_dir,"sgns.merge.char")
...
flags.DEFINE_string("mode", mode, "train/debug/test/prepro")
